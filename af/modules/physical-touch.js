...
/*****************************************************************
 * Physical Touch v1.1  part of the ApplicationFrame             *
...
$('escape').wrapper(function () {
    ...
    var EventObjectExtension = function EventObjectExtension(index) {
        /*      new properties are:
                    event.timeout
                    event.speed
                    event.movement          */
    ...
    var OverScrollData = function OverScrollData(target, direction, y, speed) {
        this.cursorY = y;
    ...
    //  global init hook
    var initHook = function initHook(e, index) {
        touchMeta[index] = {
    ...
    //  global movment hook
    var movmentHook = function movmentHook(e, index) {
    ...
    //  global release hook
    var releaseHook = function releaseHook(e, index) {
        EventObjectExtension.apply(e, [index]);
    ...
    var physicalScroll = function physicalScroll(target, movement, isGrabbed) {
    ...
    var physicalVScroll = function physicalVScroll(target, movement, isGrabbed) {
    ...
    var stretching = function stretching(F) {
        var D = 3;
